...
func BreakoutResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^Breakout$"), ""),
				},
				Default: stringdefault.StaticString("Breakout"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the Breakout",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "BreakoutStatus defines the observed state of Breakout",
			},
		},
	}
}

type BreakoutModel struct {
