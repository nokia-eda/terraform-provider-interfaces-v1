...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-interfaces/internal/datasource_workflow_get_inputs_resp_elem"
...
const read_ds_workflowGetInputsRespElem = "/workflows/v1/interfaces.eda.nokia.com/v1/namespaces/{namespace}/checkinterfacess/{name}/_input"
