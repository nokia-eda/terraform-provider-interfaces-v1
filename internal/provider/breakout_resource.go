...
const (
	create_rs_breakout = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/breakouts"
	read_rs_breakout   = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/breakouts/{name}"
	update_rs_breakout = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/breakouts/{name}"
	delete_rs_breakout = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/breakouts/{name}"
)
