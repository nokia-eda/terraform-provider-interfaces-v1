...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-interfaces/internal/resource_interface"
	"github.com/nokia/eda/apps/terraform-provider-interfaces/internal/tfutils"
)

const (
	create_rs_interface = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/interfaces"
	read_rs_interface   = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/interfaces/{name}"
	update_rs_interface = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/interfaces/{name}"
	delete_rs_interface = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/interfaces/{name}"
)
...
func (r *interfaceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_interface, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_interface, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_interface,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *interfaceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_interface, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *interfaceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_interface, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
