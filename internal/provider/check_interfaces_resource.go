...
const (
	create_rs_checkInterfaces = "/workflows/v1/interfaces.eda.nokia.com/v1/namespaces/{namespace}/checkinterfacess"
	read_rs_checkInterfaces   = "/workflows/v1/interfaces.eda.nokia.com/v1/namespaces/{namespace}/checkinterfacess/{name}"
	delete_rs_checkInterfaces = "/workflows/v1/interfaces.eda.nokia.com/v1/namespaces/{namespace}/checkinterfacess/{name}"
)
