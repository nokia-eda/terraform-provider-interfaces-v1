...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-interfaces/internal/datasource_interface"
...
const read_ds_interface = "/apps/interfaces.eda.nokia.com/v1/namespaces/{namespace}/interfaces/{name}"
...
func (d *interfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_interface, map[string]string{
...
func (r *interfaceDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
