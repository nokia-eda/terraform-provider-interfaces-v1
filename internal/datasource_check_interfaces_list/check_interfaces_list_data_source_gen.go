...
package datasource_check_interfaces_list
...
func CheckInterfacesListDataSourceSchema(ctx context.Context) schema.Schema {
...
type CheckInterfacesListModel struct {
